...
public class MenActivity extends AppCompatActivity implements ExitDialog.ExitListener {
    ...
    private void loadData() {
        ...
        ListView listView = findViewById(R.id.men_list);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                dialogFragment.show((MenActivity.this).getSupportFragmentManager(), "Item Dialog");
            }
        });
